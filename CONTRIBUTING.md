...
Thank you for your interest in contributing to AnimatedImage. AnimatedImage displays animated images (GIF, APNG, and animated WebP) in SwiftUI with an API shaped after `Image` and `AsyncImage`.

## How to Contribute

Contributions to AnimatedImage are warmly welcomed and appreciated. Here are the areas where you can help:
...
1. Fork the [AnimatedImage repository](https://github.com/KC-2001MS/AnimatedImage) and clone it to your local machine.
...
AnimatedImage adheres to the Contributor Covenant Code of Conduct (https://github.com/KC-2001MS/AnimatedImage/blob/main/CODE_OF_CONDUCT.md) to create an inclusive and respectful environment for all users. Harassment of any kind is strictly prohibited. Kindly review the Code of Conduct for further details.
...
Your interest, assistance, and feedback are invaluable in enhancing the AnimatedImage library. Thank you for your continued support.
